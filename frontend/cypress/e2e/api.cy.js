...
describe("API tests", () => {
  context("Without correct login", () => {
    it("should return an error 403 when trying to access the cart of a user without being authenticated", () => {
  ...
  context("With correct login", () => {
    ...
    it("should return the product list of the cart", function () {
      cy.env(["apiUrl"]).then(({ apiUrl }) => {
        cy.request({
          method: "GET",
          url: `${apiUrl}/orders`,
